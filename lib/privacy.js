...
function privacy (opts) {
  return new Promise((resolve) => {
    ...
    .then(() => {
      const tokenUrl = `https://apps.apple.com/gb/app/id${opts.id}`;
    ...
    .then((html) => {
      ...
      const url = `https://amp-api.apps.apple.com/v1/catalog/GB/apps/${opts.id}?platform=web&fields=privacyDetails&l=en-gb`;
